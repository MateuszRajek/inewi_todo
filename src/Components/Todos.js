...
import { Card, Checkbox, Heading, Text, Label } from 'theme-ui'
...
const Todos = () => {
    ...
    return (
        <Card>
            ...
            <Text sx={{overflowX: 'scroll'}}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
                ...
                including versions of Lorem Ipsum.Why do we use it?It is a long established fact that a reader will be distracted by the 
                ...
                uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on 
                purpose (injected humour and t
            </Text>
            <Label>
                <Checkbox />
                Completed
